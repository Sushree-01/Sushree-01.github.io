...
const Contact = () => {
  return (
    ...
    <FormControl as="form" action="https://getform.io/f/92297267-3fd4-4788-8c74-2cab2ec9bb1f" method="POST" style={{width:"40%",textAlign:"center"}}>
    ...
    <div style={{ display: "flex", justifyContent: "center", flexDirection: "row", width:"50%", gap:"2%",marginTop:"10px" }}>
          <a 
          href="subhashree.payal2000@gmail.com" >
             <>
