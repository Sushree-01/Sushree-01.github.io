import {
  ...
  import photo from "../Image/Sushree_Subhashree_img.jpeg"
  import { ReactElement } from "react";
  import Resume from "../Image/Sushree_Resume.pdf"
  ...
  export default function Home() {
    ...
    function handleResume() {
      window.open(
        `http://localhost:3000/static/media/Sushree_Resume.f0b3f8db39da35fd6132.pdf`
      );
    }
    return (
      <>
                ...
                >
                  ...
                  <Flex justifyContent={"space-around"} w="25%">
                    <Link
                      m="5px"
                      id="contact-github"
                      href="https://github.com/Sushree-01"
                      target="_blank"
                    >
                      <svg
                    ...
                    <Link
                      m="5px"
                      id="contact-linkedin"
                      href="https://www.linkedin.com/in/subhashree-sahoo-ba295b251/"
                      target="_blank"
                    >
                      <svg
                        fill={colorMode === "light" ? "black" : "white"}
                ...
                <Stack>
                  ...
                  <Flex mt={{ base: "20px", sm: "0px" }}>
                    ...
                    <Text id="contact-email" ml={"10px"}>
                      subhashree.payal2000@gmail.com
                    </Text>
                  </Flex>
                </Stack>
              </Stack>
